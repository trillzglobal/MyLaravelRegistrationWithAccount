...
Route::middleware('storeRequest')->group(function(){
    ...
    Route::group([
        	...
        	Route::get('transaction/graph', [App\Http\Controllers\TransactionControllers\UserInformation::class, 'transactionSummary']); //Done {Include summay of Purchase By Customer}
        	Route::get('users/incentives', [App\Http\Controllers\TransactionControllers\UserInformation::class, 'incentive']); //Done {Includes a list of Bonus Earn By user}
